...
So far the model has been a black box. Chapter 6 handed it a batch and got logits back, and
...
**Chapter 11** — loading. This looks like file I/O and is really a distributed sharding
...
**Chapter 12** — anatomy. SGLang rewrites every model rather than importing it from Hugging
Face, and the chapter walks the Llama implementation line by line to show why: every layer has to
cooperate with parallelism, quantization, and the paged cache of Chapter 8. By the end you
will be able to read any of the 218 model files in the repository.

**Chapter 13** — attention. One line in a model file dispatches to the most heavily
...
**Chapter 14** — making it cheap. Three independent taxes on the forward pass — bytes moved,
