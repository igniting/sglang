...
Chapter 9 spent a chapter on. The frontier models are several times larger again.
...
**Chapter 16** covers the classical axes: splitting within each layer, splitting between
...
**Chapter 17** is about mixture-of-experts models, where the cost structure changes shape
...
**Chapter 18** takes the final step. Chapter 1 showed that prefill and decode are opposite
workloads — one compute-bound, one memory-bound. Chapter 6 showed the scheduler negotiating
...
which turns out to depend on Chapter 10.
